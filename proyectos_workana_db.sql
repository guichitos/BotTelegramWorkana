...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2025 a las 03:34:01
...
--
ALTER TABLE `proyectos` ADD CONSTRAINT `fk_proyectos_usuario` FOREIGN KEY (`user_id`) REFERENCES `usuarios_bot` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `user_skills`
--
ALTER TABLE `user_skills` ADD CONSTRAINT `fk_user_skills_user` FOREIGN KEY (`user_id`) REFERENCES `usuarios_bot` (`id`) ON DELETE CASCADE;
